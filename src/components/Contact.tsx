        ...
        <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
          ...
          <div className="lg:w-1/3 space-y-8">
            ...
            <div className="mt-8 rounded-lg overflow-hidden h-64 shadow-md">
              <iframe
                title="Google Maps"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2932.456789012345!2d23.321867!3d42.697708!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDLCsDQxJzUxLjgiTiAyM8KwMTknMTguNyJF!5e0!3m2!1sen!2sbg!4v1620000000000!5m2!1sen!2sbg"
                width="100%"
                height="100%"
                style={{ border: 0 }}
