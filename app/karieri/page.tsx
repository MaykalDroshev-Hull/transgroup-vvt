import { DollarSign, Hospital, Book, Building, Clock, Users } from "lucide-react";
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            <button className="bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-colors shadow-lg">
              Изпрати CV
            </button>
          </div>
        </div>
